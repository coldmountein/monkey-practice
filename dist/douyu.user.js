...
/******/ (() => {
  ...
  /******/ var __webpack_modules__ = {
    /***/ 752: /***/ (__unused_webpack_module, exports) => {
      ...
      var autoSelectClarity = function (rid, videoSub) {
        ...
        var selectClarity = function (list) {
          ...
          list.forEach(function (li) {
            ...
            li.addEventListener('click', function (e) {
              return clickClarity(li, e.isTrusted);
            });
            // 注册菜单栏
            GM_registerMenuCommand(availableClarity, function () {
              return clickClarity(li, true);
            });
          });
          // 选择默认画质
        ...
        var callback = function (mutations, observer) {
          var controller =
            videoSub === null || videoSub === void 0 ? void 0 : videoSub.querySelector('[value="\u753B\u8D28 "]');
          if (controller) {
            observer.disconnect();
